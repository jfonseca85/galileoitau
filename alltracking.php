<?php
	...
	$sql = "SELECT DWCDCLIE,
			...
			DWCXCLA0 
			FROM DWATPDI 
			WHERE DWTPPOI = '3599340' AND  (DWDSUSR3 > '2014-05-27' AND DWDSUSR3 < '2014-05-28') ORDER BY DWDSUSR3 DESC LIMIT 1
			";
  ...
  <head>
    ...
    function initialize() {
		...
		var overlayMaps = {
			...
			"Ruta realizada": EstadoSaoPaulo,
			"Entregas realizadas": SucursalesITAUOverlay
		};
