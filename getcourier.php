<?php
	...
	$conn = pg_connect("dbname='AEX_PY' user='osmuser' password='osmuser' host='10.0.0.200'");
	if (!$conn) {
	...
	$sql = "SELECT DWCDCLIE,
			...
			DWCXCLA0 
			FROM DWATPDI 
			WHERE DWTPPOI = '16' AND  (DWDSUSR3 > '2014-08-05' AND DWDSUSR3 < '2014-08-06')
			";
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8"> 
  <head>
    ...
    function initialize() {
		...
		var SucursalesITAU = L.geoJson(SucursalesITAUGeoJSON, {
			...
			onEachFeature: function (feature, layer) {
				var popupText = '<a target="_blank" href="' + 'https://www.itau.com.br/' + '">' +
								...
								'</a>' +
								'<h4>Recibio: ' + feature.properties.recibio + '</h4>' +
		...
		var overlayMaps = {
			...
			"Entregas (Single)": SucursalesITAU,
			"Entregas (Grupo)": SucursalesITAUOverlay
		};
 ...
 <!--    <div id="map" style="width: 800px; height: 600px;"></div>   -->
	...
	<a href="javascript:show_calendar('document.tstest.timestamp', document.tstest.timestamp.value);"><img src="images/cal.gif" width="16" height="16" border="0" alt="Desde...:"></a>
	</form>
